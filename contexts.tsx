...
const translations = {
  ...
  vi: {
    ...
    footerText: "MemoryCare © {year}",
    language: "Ngôn ngữ",
    welcomeTitle: "Bảng Điều Khiển Hôm Nay",
    welcomeSubtitle: "Đây là tóm tắt trong ngày của bạn.",
    welcomeMessage: "Ứng dụng này được thiết kế để giúp bạn quản lý ngày của mình, ghi nhớ thông tin quan trọng và luôn kết nối.",
    todaysSchedule: "Lịch trình trong ngày",
    noActivitiesToday: "Không có hoạt động cho hôm nay. Sẵn sàng lên kế hoạch?",
    goToPlanner: "Đến trang Kế hoạch",
    familiarFace: "Gương mặt thân quen",
    noPeopleToAdd: "Chưa có ai ở đây. Thêm người thân nào.",
    goToMemoryLog: "Đến Nhật ký",
