...
const translations = {
  ...
  vi: {
    ...
    welcomeSubtitle: "Cùng xem qua các hoạt động trong ngày của bạn.",
    ...
    noActivitiesToday: "Hôm nay chưa có hoạt động nào. Cùng lên kế hoạch nhé?",
    goToPlanner: "Tới trang Lịch trình",
    familiarFace: "Gương mặt thân quen",
    noPeopleToAdd: "Chưa có ai được thêm. Hãy thêm người thân của bạn nhé.",
    goToMemoryLog: "Tới trang Nhật ký",
    quickActions: "Tác vụ nhanh",
    featureMemoryLogTitle: "Nhật ký Kỷ niệm",
    featureMemoryLogDesc: "Ghi nhớ về người thân và những suy nghĩ hàng ngày của bạn.",
    featurePlannerTitle: "Lên Lịch Hoạt Động",
    featurePlannerDesc: "Sắp xếp các hoạt động hàng ngày và nhận lời nhắc nhở.",
    featureLocationTitle: "Tìm Đường & Vị Trí",
    featureLocationDesc: "Giúp bạn tìm đường đi và giữ an toàn.",
    reminderTitle: "Lời nhắn gửi yêu thương",
    reminderText: "Mỗi ngày đều là một hành trình mới. Luôn có chúng tôi ở đây đồng hành cùng bạn. Khi cần trợ giúp, đừng ngần ngại liên hệ với người chăm sóc hoặc người thân nhé.",
    ...
    journalSavedSuccess: "Đã lưu nhật ký!",
    journalNoSpeechInfo: "Không nhận được giọng nói để lưu lại.",
    ...
    ttsLanguageUnavailableError: "Thiết bị của bạn không có giọng đọc phù hợp với ngôn ngữ đã chọn. Chức năng đọc sẽ bị hạn chế.",
    peopleSectionTitle: "Người thân",
    addPersonButton: "Thêm Người thân",
    noPeopleYet: 'Chưa có ai được thêm. Hãy bấm "Thêm Người thân" để bắt đầu nhé.',
    recallButton: "Gợi Nhớ",
    editButton: "Sửa",
    deleteButton: "Xóa",
    personRecallSpeech: "Đây là {name}, là {relationship} của bạn. {keyInfo}",
    journalSectionTitle: "Ghi chú hàng ngày",
    journalDescription: "Hãy kể lại những suy nghĩ, cảm xúc hay hoạt động trong ngày của bạn bằng giọng nói nhé.",
    speechNotSupported: "Trình duyệt của bạn không hỗ trợ nhận dạng giọng nói.",
    listeningPlaceholder: "Tôi đang nghe...",
    recordedThoughtsPlaceholder: "Nội dung bạn ghi âm sẽ hiện ở đây...",
    ...
    pageTitlePlanner: "Lịch trình hoạt động hàng ngày",
    pageSubtitlePlanner: "Sắp xếp các hoạt động và nhận lời nhắc đúng giờ.",
    ...
    noActivitiesYet: 'Chưa có hoạt động nào được lên lịch. Hãy bấm "Thêm hoạt động" để bắt đầu nhé.',
    ...
    homeSetError: "Chưa thể lưu vị trí nhà do không xác định được vị trí hiện tại.",
    guideHomeError: "Không thể chỉ đường về nhà vì chưa biết vị trí hiện tại. Bạn hãy thử làm mới vị trí xem sao nhé.",
    guideHomeNotSetInfo: "Bạn chưa lưu vị trí nhà. Hãy lưu lại trước nhé.",
    destinationMissingInfo: "Bạn hãy nhập điểm đến nhé.",
    notifyFamilySuccess: "Đã gửi thông báo đến người thân tại {emails}.",
    notifyFamilyNoEmails: "Bạn chưa thêm email người thân. Hãy vào Cài đặt để thêm nhé.",
    ...
    noSavedPlaces: "Bạn chưa lưu địa điểm nào. Hãy dùng nút 'Lưu địa điểm này' để thêm nhé.",
    ...
    mapError: "Không tải được bản đồ. Bạn vui lòng kiểm tra lại kết nối mạng nhé.",
    mapApiKeyError: "Khóa API Goong (GOONG_API_KEY) chưa được cấu hình. Khóa này khác với khóa Gemini.",
    geocodeError: "Không tìm thấy địa điểm '{destination}'. Bạn hãy thử tìm với tên khác nhé.",
    ...
    sharePlanSuccess: "Lịch trình hôm nay đã được gửi tới {emails}.",
    sharePlanNoEmails: "Bạn chưa thêm email người thân. Hãy vào Cài đặt để thêm liên hệ và chia sẻ lịch trình nhé.",
    ...
    myStoryAnswerPlaceholder: "Hãy chia sẻ những dòng suy nghĩ và ký ức của bạn tại đây...",
    myStorySaveAndUpdateButton: "Vun đắp câu chuyện",
    myStoryTitle: "Câu Chuyện Cuộc Đời Tôi",
    myStoryInitialStory: "Câu chuyện của bạn sẽ được viết nên từ những câu trả lời. Hãy bắt đầu với câu hỏi đầu tiên nhé.",
    myStoryLoadingStory: "Đang dệt nên câu chuyện tuyệt đẹp từ ký ức của bạn...",
    myStoryLoadingQuestion: "Để tôi nghĩ một câu hỏi mới cho bạn nhé...",
