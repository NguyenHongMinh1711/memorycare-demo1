...
const translations = {
  en: {
    ...
    destinationMissingInfo: "Please select a destination from the list.",
    ...
    mapApiKeyError: "Geoapify API key (GEOAPIFY_API_KEY) is not configured. This is different from the Gemini key.",
    geocodeError: "Could not find the location '{destination}'. Please select a valid destination from the suggestions.",
  ...
  vi: {
    ...
    destinationMissingInfo: "Vui lòng chọn một điểm đến từ danh sách.",
    ...
    mapApiKeyError: "Khóa API Geoapify (GEOAPIFY_API_KEY) chưa được cấu hình. Khóa này khác với khóa Gemini.",
    geocodeError: "Không tìm thấy địa điểm '{destination}'. Vui lòng chọn một điểm đến hợp lệ từ các gợi ý.",
