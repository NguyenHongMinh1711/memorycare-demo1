...
const AIAssistant: React.FC<AIAssistantProps> = ({ systemInstruction }) => {
  ...
  return (
    <div className="fixed inset-x-0 top-[72px] bottom-[64px] md:inset-0 bg-black bg-opacity-30 backdrop-blur-sm z-50 flex items-center justify-center p-2 sm:p-4 animate-fadeIn">
      <div className="bg-slate-50 rounded-xl shadow-2xl w-full max-w-lg h-full md:max-h-[90vh] flex flex-col animate-scaleIn">
